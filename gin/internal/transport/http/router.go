...
func NewRouter(
	...
	mux.Handle("GET /v1/play/rooms", authn.Require(http.HandlerFunc(playRoomHandler.ListRooms)))
	mux.Handle("GET /v1/play/rooms/{room_code}/state", authn.Require(http.HandlerFunc(playRoomHandler.RoomState)))
	mux.Handle("GET /v1/play/rooms/{room_code}/history", authn.Require(http.HandlerFunc(playRoomHandler.RoomHistory)))
