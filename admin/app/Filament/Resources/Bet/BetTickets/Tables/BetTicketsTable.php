    ...
    public static function configure(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('stake')->label('Tiền cược gốc')->money('VND')->sortable(),
                TextColumn::make('original_amount')->label('Số tiền gốc')->money('VND')->toggleable(isToggledHiddenByDefault: true),
                TextColumn::make('tax_amount')->label('Thuế cược 2%')->money('VND')->toggleable(isToggledHiddenByDefault: true),
                TextColumn::make('net_amount')->label('Tiền tính thưởng')->money('VND')->sortable(),
