...
class ResetGamePeriodsCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $this->line('Luu y: period_index khong phai auto increment cua database, app se gan theo dinh dang YYYY + 8 chu so tang dan, khoi tao tu moc cao rieng theo tung phong.');
