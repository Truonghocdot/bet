...
export const quickActions = [
  { title: 'Nạp tiền', symbol: 'add_card', to: '/deposit', accent: '#24b561' },
  { title: 'Thông báo', symbol: 'notifications', to: '/notifications', accent: '#e64545' },
  { title: 'Hoạt động', symbol: 'campaign', to: '/promotion', accent: '#f6c32d' },
  { title: 'Phòng chơi', symbol: 'sports_esports', to: '/play', accent: '#ff6d66' },
  { title: 'Cá nhân', symbol: 'person', to: '/account', accent: '#ff6d66' },
]
...
export const newsArticles: NewsArticle[] = [
  ...
  },
  {
    ...
    cover: 'from-[#ff6d66] via-[#ff8f88] to-[#ffd4d0]',
  ...
  },
  {
    ...
    cover: 'from-[#f6c32d] via-[#ffe17a] to-[#fff6c9]',
    category: 'VIP Club',
  ...
  },
  {
    ...
    cover: 'from-[#e64545] via-[#ff8f88] to-[#ffd6d6]',
    category: 'Referral',
