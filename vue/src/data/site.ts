...
export const quickActions = [
  { title: 'Nạp tiền', symbol: 'add_card', to: '/deposit', accent: '#f2ad00' },
  { title: 'Thông báo', symbol: 'notifications', to: '/notifications', accent: '#ffc928' },
  { title: 'Hoạt động', symbol: 'campaign', to: '/promotion', accent: '#d89500' },
  { title: 'Phòng chơi', symbol: 'sports_esports', to: '/play', accent: '#f2ad00' },
  { title: 'Cá nhân', symbol: 'person', to: '/account', accent: '#9a9b9e' },
]
...
export const newsArticles: NewsArticle[] = [
  ...
  },
  {
    ...
    cover: 'from-[#595a5d] via-[#434447] to-[#303133]',
  ...
  },
  {
    ...
    cover: 'from-[#d89500] via-[#f2ad00] to-[#ffc928]',
    category: 'VIP Club',
  ...
  },
  {
    ...
    cover: 'from-[#4b4c4f] via-[#38393b] to-[#292a2c]',
    category: 'Referral',
