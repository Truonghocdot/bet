    ...
    betGroups: [
      {
        ...
        mode: 'chips',
        options: [
          { key: 'green', label: 'Xanh', accent: '#10b981' },
          { key: 'red', label: 'Đỏ', accent: '#ef4444' },
      ...
      },
      {
        ...
        options: Array.from({ length: 10 }, (_, number) => ({
          key: `number_${number}`,
          label: String(number),
          accent: number % 3 === 0 ? '#10b981' : number % 3 === 1 ? '#ef4444' : '#8b5cf6',
        })),
      },
      {
        title: 'Lớn / Nhỏ',
        ...
        mode: 'chips',
        options: [
          { key: 'big', label: 'LỚN', accent: '#b45309' },
          { key: 'small', label: 'NHỎ', accent: '#2563eb' },
        ],
      },
    ],
    ...
    betGroups: [
      {
        ...
        options: Array.from({ length: 16 }, (_, index) => {
          const total = index + 3
          return { key: `sum_${total}`, label: String(total), accent: total >= 11 ? '#ef4444' : '#2563eb' }
        }),
      },
      {
        title: 'Chẵn / Lẻ',
        ...
        options: [
          ...
          { key: 'even', label: 'Chẵn', accent: '#0ea5e9' },
          { key: 'big', label: 'Lớn', accent: '#b45309' },
          { key: 'small', label: 'Nhỏ', accent: '#16a34a' },
        ],
      },
      {
        title: 'Bộ ba',
        ...
        mode: 'chips',
        options: [
          { key: 'triple_any', label: 'Any Triple', accent: '#f59e0b' },
          { key: 'triple_111', label: '111', accent: '#dc2626' },
          { key: 'triple_222', label: '222', accent: '#dc2626' },
          { key: 'triple_333', label: '333', accent: '#dc2626' },
          { key: 'triple_444', label: '444', accent: '#dc2626' },
          { key: 'triple_555', label: '555', accent: '#dc2626' },
          { key: 'triple_666', label: '666', accent: '#dc2626' },
        ],
      },
    ],
  ...
  return {
    ...
    betGroups: [
      ...
      },
      {
        ...
        mode: 'chips',
        options: [
          { key: 'last_0', label: 'Đuôi 0', accent: '#dc2626' },
          { key: 'last_5', label: 'Đuôi 5', accent: '#dc2626' },
          { key: 'sum_15', label: 'Tổng 15', accent: '#f59e0b' },
          { key: 'sum_30', label: 'Tổng 30', accent: '#f59e0b' },
        ],
      },
    ],
